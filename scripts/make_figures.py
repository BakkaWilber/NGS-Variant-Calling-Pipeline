...
for step in steps:
    ...
    ax.add_patch(box)
    ax.text(0.5, y - 0.015, step, ha="center", va="center", fontsize=11)
...
ax.set_title("End-to-End NGS Variant Calling Pipeline", fontsize=15)
...
# -----------------------------
metrics = ["Reads (x1000)", "Read1 Q30 (%)", "Read2 Q30 (%)"]
...
ax.set_title("Quality Metrics Before vs After Trimming")
ax.legend()
